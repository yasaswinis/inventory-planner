...
public class DownloadIPCReviewCommandTest {
    ...
    public void downloadTestWithoutLastAppSupplier() throws IOException {
        ...
        downloadIPCReviewCommand.execute(requirements,false,"IPC_REVIEW");
        Mockito.verify(generateExcelCommand).generateExcel(captor.capture(), Mockito.eq("/templates/IPCReview.xlsx"),Mockito.eq("IPC_REVIEW"));
