...
public class DownloadPreProposedCommandTest {
    ...
    public void downloadTest() throws IOException {
        ...
        downloadPreProposedCommand.execute(requirements,false, "PRE_PROPOSED");
        Mockito.verify(generateExcelCommand).generateExcel(captor.capture(), Mockito.eq("/templates/pre_proposed.xlsx"), Mockito.eq("PRE_PROPOSED"));
