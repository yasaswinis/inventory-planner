...
public class IPCFinalisedCommandTest {
    ...
    public void downloadTest() throws IOException {
        ...
        downloadIPCFinalisedCommand.execute(requirements,false,"IPC_FINALISED");
        Mockito.verify(generateExcelCommand).generateExcel(captor.capture(), Mockito.eq("/templates/IPCFinalised.xlsx"),Mockito.eq("IPC_FINALISED"));
